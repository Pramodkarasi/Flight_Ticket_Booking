...
body {
	...
	background: #efefef;
  background: -webkit-linear-gradient(to right, #a1252f, #e3e3e3); 
  background: linear-gradient(to right, #a1252f, #e3e3e3); 
}
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								<h3 style="color: rgba(0, 0, 0, 0.767);">From</h3>
								<?php
							...
							<div class="to">
								<h3 style="color: rgba(0, 0, 0, 0.767);">To</h3>
								<?php
								$sql = 'SELECT * FROM Cities ';
								$stmt = mysqli_stmt_init($conn);
								mysqli_stmt_prepare($stmt,$sql);         
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(0, 0, 0, 0.767);">Passenger</h3>
									<div class="quantity"> 
