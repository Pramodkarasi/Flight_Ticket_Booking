...
.dashbord-red .detail-section{
    ...
    <main>
      ...
      <div class="card-body">
          ...
          <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #a1252f;">
        ...
        <thead class="table-dark" style="background-color: #a1252f;">
            <tr>
              <th scope="col">#</th>
